...
export const en = {
  ...
  errors: {
    codes: {
      ...
      RENDER_QUESTION_NOT_IN_INBOX: "That question is no longer in your inbox.",
      RENDER_START_FAILED: "We couldn't start the image render. Please try again.",
      LOGIN_INIT_FAILED: "We couldn't start the login. Please try again.",
