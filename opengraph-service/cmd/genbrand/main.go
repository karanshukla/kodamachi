...
type brand struct {
	...
	MarkTileRadius float64 `json:"markTileRadius"`
	MarkGlyphPath  string  `json:"markGlyphPath"`
}
...
func main() {
	...
	content := fmt.Sprintf(tmpl, *in, b.AppName, b.MarkTileRadius, b.MarkGlyphPath)
